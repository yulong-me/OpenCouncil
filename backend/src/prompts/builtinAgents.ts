...
const LITIGATION_STRATEGY_TEAM_TAG = '诉讼策略';
const COMPETITOR_ANALYSIS_TEAM_TAG = '竞品分析';
const PAPER_REVISION_TEAM_TAG = '论文返修';
export const SOFTWARE_DEVELOPMENT_TEAM_TAG = '软件开发';
...
const DEV_REQUIREMENTS_SYSTEM_PROMPT = `你是软件开发团队中的需求分析师。
...
const DEV_ARCHITECT_SYSTEM_PROMPT_LEGACY = `你是软件开发团队中的架构师。
...
const DEV_ARCHITECT_SYSTEM_PROMPT_V4 = `你是软件开发团队中的架构师。
...
const DEV_LEAD_ARCHITECT_SYSTEM_PROMPT = `你是软件开发团队中的主架构师。
...
const DEV_CHALLENGE_ARCHITECT_SYSTEM_PROMPT = `你是软件开发团队中的挑战架构师。
...
const DEV_IMPLEMENTER_SYSTEM_PROMPT_V4 = `你是软件开发团队中的实现工程师。
...
const DEV_IMPLEMENTER_SYSTEM_PROMPT = `你是软件开发团队中的实现工程师。
...
const DEV_REVIEWER_SYSTEM_PROMPT_LEGACY = `你是软件开发团队中的代码 Reviewer。
...
const DEV_REVIEWER_SYSTEM_PROMPT_V4 = `你是软件开发团队中的代码 Reviewer。
...
const DEV_REVIEWER_SYSTEM_PROMPT = `你是软件开发团队中的代码 Reviewer。
...
const DEV_QA_SYSTEM_PROMPT = `你是软件开发团队中的测试工程师。
...
const LITIGATION_CASE_MAPPER_SYSTEM_PROMPT = `你是诉讼策略团队中的案情梳理官。
...
const LITIGATION_EVIDENCE_STRATEGIST_SYSTEM_PROMPT = `你是诉讼策略团队中的证据策略官。
...
const LITIGATION_OPPOSING_COUNSEL_SYSTEM_PROMPT = `你是诉讼策略团队中的对方律师。
...
const LITIGATION_RISK_CONTROLLER_SYSTEM_PROMPT = `你是诉讼策略团队中的诉讼风险官。
...
const COMPETITOR_MARKET_MAPPER_SYSTEM_PROMPT = `你是竞品分析团队中的市场地图分析师。

你的职责：
- 定义目标用户、使用任务、直接竞品、替代方案和非竞品
- 区分事实、假设和未知项，不编造市场数据
...
const COMPETITOR_POSITIONING_STRATEGIST_SYSTEM_PROMPT = `你是竞品分析团队中的定位策略师。
...
const COMPETITOR_PRODUCT_SKEPTIC_SYSTEM_PROMPT = `你是竞品分析团队中的产品怀疑者。
...
const COMPETITOR_GTM_OPERATOR_SYSTEM_PROMPT = `你是竞品分析团队中的 GTM 操盘手。
...
const PAPER_REVIEW_DIAGNOSER_SYSTEM_PROMPT = `你是论文返修团队中的审稿意见诊断师。
...
const PAPER_METHODS_EDITOR_SYSTEM_PROMPT = `你是论文返修团队中的方法实验顾问。
...
const PAPER_REBUTTAL_WRITER_SYSTEM_PROMPT = `你是论文返修团队中的 Rebuttal 主笔。
...
const PAPER_HOSTILE_REVIEWER_SYSTEM_PROMPT = `你是论文返修团队中的苛刻审稿人。
...
const LITIGATION_STRATEGY_AGENT_DEFINITIONS: BuiltinAgentDefinition[] = [
  {
    ...
    tags: [LITIGATION_STRATEGY_TEAM_TAG, '事实', 'expert'],
  ...
  },
  {
    ...
    provider: 'opencode',
    providerOpts: { thinking: true },
    tags: [LITIGATION_STRATEGY_TEAM_TAG, '证据', 'expert'],
  ...
  },
  {
    ...
    provider: 'opencode',
    providerOpts: { thinking: true },
    tags: [LITIGATION_STRATEGY_TEAM_TAG, '攻防', 'expert'],
  ...
  },
  {
    ...
    provider: 'opencode',
    providerOpts: { thinking: true },
    tags: [LITIGATION_STRATEGY_TEAM_TAG, '风险', 'expert'],
...
const COMPETITOR_ANALYSIS_AGENT_DEFINITIONS: BuiltinAgentDefinition[] = [
  {
    ...
    provider: 'opencode',
    providerOpts: { thinking: true },
    tags: [COMPETITOR_ANALYSIS_TEAM_TAG, '市场', 'expert'],
  ...
  },
  {
    ...
    provider: 'opencode',
    providerOpts: { thinking: true },
    tags: [COMPETITOR_ANALYSIS_TEAM_TAG, '定位', 'expert'],
  ...
  },
  {
    ...
    provider: 'opencode',
    providerOpts: { thinking: true },
    tags: [COMPETITOR_ANALYSIS_TEAM_TAG, '产品', 'expert'],
  ...
  },
  {
    ...
    provider: 'opencode',
    providerOpts: { thinking: true },
    tags: [COMPETITOR_ANALYSIS_TEAM_TAG, 'GTM', 'expert'],
...
const PAPER_REVISION_AGENT_DEFINITIONS: BuiltinAgentDefinition[] = [
  {
    ...
    provider: 'opencode',
    providerOpts: { thinking: true },
    tags: [PAPER_REVISION_TEAM_TAG, '审稿意见', 'expert'],
  ...
  },
  {
    ...
    provider: 'opencode',
    providerOpts: { thinking: true },
    tags: [PAPER_REVISION_TEAM_TAG, '实验', 'expert'],
  ...
  },
  {
    ...
    provider: 'opencode',
    providerOpts: { thinking: true },
    tags: [PAPER_REVISION_TEAM_TAG, '写作', 'expert'],
  ...
  },
  {
    ...
    provider: 'opencode',
    providerOpts: { thinking: true },
    tags: [PAPER_REVISION_TEAM_TAG, 'review', 'expert'],
...
export const LEGACY_SOFTWARE_DEVELOPMENT_AGENT_DEFINITIONS: BuiltinAgentDefinition[] = [
  {
    ...
    provider: 'opencode',
    providerOpts: { thinking: true },
    tags: [SOFTWARE_DEVELOPMENT_TEAM_TAG, '需求', 'expert'],
  ...
  },
  {
    ...
    provider: 'opencode',
    providerOpts: { thinking: true },
    tags: [SOFTWARE_DEVELOPMENT_TEAM_TAG, '架构', 'expert'],
  ...
  },
  {
    ...
    provider: 'opencode',
    providerOpts: { thinking: true },
    tags: [SOFTWARE_DEVELOPMENT_TEAM_TAG, '实现', 'expert'],
  ...
  },
  {
    ...
    provider: 'opencode',
    providerOpts: { thinking: true },
    tags: [SOFTWARE_DEVELOPMENT_TEAM_TAG, 'review', 'expert'],
  ...
  },
  {
    ...
    provider: 'opencode',
    providerOpts: { thinking: true },
    tags: [SOFTWARE_DEVELOPMENT_TEAM_TAG, '测试', 'expert'],
...
export const SOFTWARE_DEVELOPMENT_AGENT_DEFINITIONS: BuiltinAgentDefinition[] = [
  ...
  },
  {
    ...
    provider: 'opencode',
    providerOpts: { thinking: true },
    tags: [SOFTWARE_DEVELOPMENT_TEAM_TAG, '架构', 'review', 'expert'],
